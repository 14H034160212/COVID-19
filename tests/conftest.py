...
def insert_data(session):
    ...
    session.execute(
        ...
        dict(user_one=user_keys[0], user_two=user_keys[1], article_one=article_keys[0], article_two=article_keys[1],
